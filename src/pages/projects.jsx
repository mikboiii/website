...
const personalPosts = [
  {
    id: 1,
    title: 'Nightfall Extraction',
    href: 'https://itch.io/jam/scream-jam-2024/rate/3056931',
    description:
      'A retro style horror FPS with variating mechanics.',
    imageUrl:
    nightfallSplash,
...
const otherPosts = [
  {
        id: 1,
    title: 'Observing the Relationship Between Melodic Traits and their Effect on the Suitability of a Generated Melody',
    href: 'MGDissertation.pdf',
    description:
      'A dive into desirable elements in procedural music',
    imageUrl:
    dissertationSplash,
    date: '31st March 2023',
    datetime: '2023-03-31',
    author: {
      name: 'Mikolaj Greszta',
      imageUrl:
      portraitIcon,
    }
  }
...
export default function Projects() {
  return (
    ...
    <div className="mx-auto max-w-2xl text-center py-8">
          ...
          <p className="mt-2 text-lg leading-8 text-black dark:text-white">
            These are the projects which I&apos;ve worked on but aren&apos;t necessarily games related
          </p>
        </div>
        <div className="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-0 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {otherPosts.map((post) => (
